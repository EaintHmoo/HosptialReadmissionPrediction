...
# Form implementation generated from reading ui file 'HospitalReadmission.ui'
#
...
class Ui_TabWidget(QTabWidget):
    ...
    def __init__(self):
        try:
            super(Ui_TabWidget, self).__init__()
            uic.loadUi('../View/hospitalReadmission.ui', self)
